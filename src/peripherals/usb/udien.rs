...
impl R {
    ...
    #[doc = "Bit 4 - Wake-up CPU Interrupt Enable"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 6 - Upstream Resume Interrupt Enable"]
    #[inline]
    pub fn uprsme(&mut self) -> _UPRSMEW {
        _UPRSMEW { w: self }
    }
    #[doc = "Bit 5 - End Of Resume Interrupt Enable"]
    #[inline]
    pub fn eorsme(&mut self) -> _EORSMEW {
        _EORSMEW { w: self }
    }
    #[doc = "Bit 4 - Wake-up CPU Interrupt Enable"]
    #[inline]
    pub fn wakeupe(&mut self) -> _WAKEUPEW {
        _WAKEUPEW { w: self }
    }
    #[doc = "Bit 3 - End Of Reset Interrupt Enable"]
    #[inline]
    pub fn eorste(&mut self) -> _EORSTEW {
        _EORSTEW { w: self }
    }
    #[doc = "Bit 2 - Start Of Frame Interrupt Enable"]
    #[inline]
