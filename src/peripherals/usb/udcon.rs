...
impl R {
    ...
    #[doc = "Bit 3 - Reset CPU Bit"]
    #[inline]
    pub fn rstcpu(&self) -> RSTCPUR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
    ...
    #[doc = "Bit 2 - Low Speed Mode Selection"]
    #[inline]
