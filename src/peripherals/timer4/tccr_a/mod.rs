...
impl R {
    ...
    #[doc = "Bit 0 - Pulse Width Modulator B"]
    #[inline]
    pub fn pwm_b(&self) -> PWM_BR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u8) != 0
...
impl W {
    ...
    #[doc = "Bit 1 - Pulse Width Modulator A"]
    #[inline]
    pub fn pwm_a(&mut self) -> _PWM_AW {
        _PWM_AW { w: self }
    }
    #[doc = "Bit 0 - Pulse Width Modulator B"]
    #[inline]
    pub fn pwm_b(&mut self) -> _PWM_BW {
        _PWM_BW { w: self }
    }
    #[doc = "Bit 3 - Force Output Compare Match A"]
    #[inline]
    pub fn foc_a(&mut self) -> _FOC_AW {
        _FOC_AW { w: self }
    }
    #[doc = "Bit 2 - Force Output Compare Match B"]
    #[inline]
